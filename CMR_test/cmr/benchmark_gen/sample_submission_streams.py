...
root_path = "/data2/home/gangwei/project/CMR/"
...
def load_datasets(args): 
    if args.task_name == "QA":
        truth_paths = {
            ...
            "squad": root_path+"data/mrqa_squad/mrqa_squad_dev.jsonl",   
            "nq": root_path+"data/mrqa_naturalquestions/mrqa_naturalquestions_dev.jsonl", #
            "trivia": root_path+"data/mrqa_triviaqa/mrqa_triviaqa_dev.jsonl",  
            "hotpot": root_path+"data/mrqa_hotpotqa/mrqa_hotpotqa_dev.jsonl",   
            "news": root_path+"data/mrqa_newsqa/mrqa_newsqa_dev.jsonl",   
            "search": root_path+"data/mrqa_searchqa/mrqa_searchqa_dev.jsonl",   
        }
        prediction_paths = {
            # "squad-train": "upstream_resources/qa_upstream_preds/mrqa_squad_train.predictions.json",   
            "squad": root_path+"upstream_resources/qa_upstream_preds/mrqa_squad_dev.predictions.json",   
            "nq": root_path+"upstream_resources/qa_upstream_preds/mrqa_naturalquestions_dev.predictions.json", 
            "trivia": root_path+"upstream_resources/qa_upstream_preds/mrqa_triviaqa_dev.predictions.json",  
            "hotpot": root_path+"upstream_resources/qa_upstream_preds/mrqa_hotpotqa_dev.predictions.json",   
            "news": root_path+"upstream_resources/qa_upstream_preds/mrqa_newsqa_dev.predictions.json", 
            "search": root_path+"upstream_resources/qa_upstream_preds/mrqa_searchqa_dev.predictions.json", 
        }
