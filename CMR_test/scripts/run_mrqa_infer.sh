...
do
    ...
    do 
        ...
        CUDA_VISIBLE_DEVICES=${gpu} python cmr/benchmark_gen/run_bart_infer.py \
            ...
            --data_file "/data2/home/gangwei/project/CMR/data/${data_name}/${dataset_name}.jsonl" \
            --prediction_file "/data2/home/gangwei/project/CMR/upstream_resources/qa_upstream_preds/tmp/${dataset_name}.predictions.${thread}_of_${n_threads}.json" \
            --conig_file "scripts/infer_mrqa_bart_base.config" \
            --prefix ${prefix} &
            # > logs/tmp/${prefix}_${thread}_of_${n_threads}.log 2>&1 &
...
do
    ...
    python cmr/benchmark_gen/merge_json_file.py \
        --input_file_pattern "/data2/home/gangwei/project/CMR/upstream_resources/qa_upstream_preds/tmp/${dataset_name}.predictions.#_of_${n_threads}.json" \
        --output_file "/data2/home/gangwei/project/CMR/upstream_resources/qa_upstream_preds/${dataset_name}.predictions.json" \
